...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            // Tolerant: clear the context and let authorize rules decide.
            // permitAll() endpoints (signup, login, validateToken, swagger)
            // still succeed; protected endpoints return 401 via the entry point.
