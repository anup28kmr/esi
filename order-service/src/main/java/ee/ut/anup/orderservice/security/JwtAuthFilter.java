package ee.ut.anup.orderservice.security;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (header == null || !header.startsWith(BEARER_PREFIX)) {
            // No token at all -- let the chain reach the authorization rules,
            // which will return 401 via RestAuthEntryPoints for protected paths
            // and let permitAll endpoints (actuator, swagger) through.
        ...
        try {
            ...
            // Token present but unrecognised. Clear the context and let the
            // authorization rules decide -- protected endpoints will 401 via
            // RestAuthEntryPoints.unauthorizedEntryPoint().
